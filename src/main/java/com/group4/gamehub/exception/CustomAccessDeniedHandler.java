...
/**
 * Handler for forbidden access attempts (HTTP 403) when the user is authenticated
 * but does not have the required permissions to access a resource.
 * <p>
 * This class implements {@link AccessDeniedHandler} and constructs a standardized
...
public class CustomAccessDeniedHandler implements AccessDeniedHandler {
    ...
    /**
     * Handles access denied exceptions by returning a structured JSON error response
