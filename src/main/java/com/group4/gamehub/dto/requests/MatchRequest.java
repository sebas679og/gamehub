 ...
 *
 * <p>This object is used in PUT requests to update the outcome of a match, specifying the result
 * (e.g., PLAYER1_WIN, PLAYER2_WIN, PENDING).
 */
@Getter
@Setter
public class MatchRequest {
   ...
   *
   * <p>Must not be blank and must match a valid {@link Result} enum value.
   */
  @Schema(
