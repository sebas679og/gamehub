 ...
 * <ul>
 *     <li>Generating matchups for a tournament</li>
 *     <li>Retrieving individual match details</li>
 *     <li>Updating the result of a specific match</li>
 * </ul>
 * <p>
 * Some endpoints are restricted to administrators via role-based authorization.
 */
@RestController
@RequestMapping("/api/match")
@Tag(
        name = "Live Matching",
        description = "Endpoints that handle player matchmaking and match result management in tournaments."
)
public class MatchController {
    ...
    @Operation(
            ...
            description = "Automatically generates player pairings for a given tournament. Restricted to administrators.",
            responses = {
                    @ApiResponse(
                            responseCode = "201",
                            description = "Created - Successfully generated and returned the list of paired players.",
                            content = @Content(mediaType = APPLICATION_JSON, schema = @Schema(implementation = MatchResponse.class))
                    ),
                    @ApiResponse(
                            responseCode = "404",
    ...
    @Operation(
            ...
            description = "Updates the result of a specific match. Only administrators can perform this action.",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
